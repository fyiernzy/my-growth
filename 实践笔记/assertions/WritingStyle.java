...
public class WritingStyle {
    ...
    public void doSomething() {
        ...
        // Cons: Reflection adds overhead (memory + CPU). Also requires registering
        //       a map, which increases manual effort and complexity.
        ...
        // Pros: Good balance between simplicity and preserving both the exception
        //       type and error code type.
        ...
        // Pros: Less verbose than writing Suppliers inline; preserves both exception
        ...
        // Cons: Adds repetitive static methods to each exception; hard to enforce
        //       consistent usage; can confuse semantics.
        AssertionUtil.notNull(
            "",
        ...
        // Pros: Retains V1’s simplicity while addressing its weaknesses; enables
        //       centralized policies (logging, i18n, metrics) via DI.
        // Cons: Using a utility-style class as a Spring component can be confusing.
        //       Requires declaring DomainAssert fields in classes, which might be overlooked.
        ...
        // Pros: Preserves both exception and error code information; fluent design
        //       is easy to extend and maintain; high cohesion and extensibility.
        // Cons: More verbose; a different style from typical guard checks; each
        //       withException/assertThat chain may allocate more objects.
        FluentAssert
