...
public class OpenTelemetrySqlExporter implements SpanExporter {
    ...
    private SqlInfo toSqlInfo(SpanData spanData) {
        ...
        String sql = Optional.ofNullable(attributes.get(DB_STATEMENT_KEY)).map(formatter::format).orElse(SharedConstant.EMPTY_STRING);
    ...
    private String orEmpty(String value) {
        return ValidatorUtils.isNotBlank(value) ? value : SharedConstant.EMPTY_STRING;
    }
